...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "readyToPost.page.subline": "Your video is live under your Shopable link and ready to be shared.",
  ...
  de: {
    ...
    "readyToPost.page.subline": "Dein Video ist unter deinem Shopable-Link erreichbar und bereit zum Teilen.",
