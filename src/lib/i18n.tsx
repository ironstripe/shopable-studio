...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "readyToPost.page.title": "Done – your video is now live",
    "readyToPost.page.subline": "Everything is ready. Your video is live under your Shopable link and can now be shared.",
    "readyToPost.page.caption.label": "📝 Your caption",
    "readyToPost.page.caption.helper": "You can paste this caption directly into Instagram, TikTok or Shorts.",
    ...
    "readyToPost.page.bio.helper": "This link is now active and opens your shoppable video.",
  ...
  de: {
    ...
    "readyToPost.page.title": "Geschafft – dein Video ist jetzt live",
    "readyToPost.page.subline": "Alles ist bereit. Dein Video ist unter deinem Shopable-Link erreichbar und kann jetzt geteilt werden.",
    "readyToPost.page.caption.label": "📝 Deine Caption",
    "readyToPost.page.caption.helper": "Diese Caption kannst du direkt in Instagram, TikTok oder Shorts einfügen.",
    ...
    "readyToPost.page.bio.helper": "Dieser Link ist jetzt aktiv und öffnet dein shoppable Video.",
